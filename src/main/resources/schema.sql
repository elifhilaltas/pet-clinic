...
alter table  public.t_pet add constraint public.constrain_2 primary key (id);
...
alter table  public.t_pet add constraint public.constrain_3 foreign key (owner_id) references public.t_owner(id);
